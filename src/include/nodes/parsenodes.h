...
typedef enum AlterTableType
{
	...
	AT_ModifyConstraint,		/* modify constraint */
...
typedef struct AlterTableCmd	/* one subcommand of an ALTER TABLE */
{
	...
	ModifyBehavior mbehavior;	/* REPLICA IDENTITY behavior */
...
typedef struct ArraySubfield
{
	NodeTag		type;		/* T_ArraySubfield */
	char	   *colname;	/* 属性名 */
	int			subfield;	/* 子级索引 */
	int 	    location;	/* 位置 */
}ArraySubfield;
